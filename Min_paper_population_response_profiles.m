...
% sessionTraces{1}=[averages.trialAverages];sessionTraces{1}=sessionTraces{1}(1,2:2:end)';
...
% 
% sessionTraces{2}=[averages.trialAverages];sessionTraces{2}=sessionTraces{2}(2,2:2:end)';
...
% 
% sessionTraces{3}=[averages.trialAverages];sessionTraces{3}=sessionTraces{3}(3,2:2:end)';
...
for subjectNum=1:4
    ...
    % use statistatical classification
